create or replace function func_shzs_rwwp_bak20250609(p_swjg_dm varchar2,p_gwdm varchar2,p_nsrsbh varchar2,p_lcswsxdm varchar2)
...
--DBMS_OUTPUT.put_line('结束--'||v_ErrMsg||'-'||v_WTDXSFDM||v_WTDXMC);
  ...
  return o_wp;
end func_shzs_rwwp_bak20250609;
/
