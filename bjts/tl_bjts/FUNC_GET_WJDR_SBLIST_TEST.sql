create or replace function func_get_wjdr_sblist_test(p_czryDm varchar2,
...
is
  ...
  v_flglcd varchar2(2);
  v_zzsbb char(1);
  v_zs_swjg_mc varchar2(80);
  v_czry_qxswjg varchar2(11);
  v_czry_swjg varchar2(11);
  v_tsjsfs char(1);
  v_sbywbmc varchar2(80);
  v_ts_swjg_mc varchar2(80);
  v_sbtmse number(18);
begin
  ...
  dyn_select:='select sbid,sssq,sbpc,sbrq,qyhgdm,nsrmc,sbywb_dm,flglcd,zzsbb,TT.swjg_jc as zs_swjg_mc,ds.swjg_jc as ts_swjg_mc,tsjsfs_dm,sd1.dname as sbywbmc,sbtmse from '
