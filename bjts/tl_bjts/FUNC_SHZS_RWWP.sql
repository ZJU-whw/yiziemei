create or replace function func_shzs_rwwp(p_swjg_dm varchar2,p_gwdm varchar2,p_nsrsbh varchar2,p_lcswsxdm varchar2)
      ...
      select wpsfdm,swrymc into v_WTDXSFDM,v_WTDXMC
        from (select t.wpsfdm,s.swrymc
               ...
               where t.wpsfdm = s.sfdm
                 ...
                 and to_char(t.wpsj, 'yyyymm') = to_char(sysdate, 'yyyymm')
