CREATE OR REPLACE PROCEDURE PROC_XXBD_JSB
/*
  编制人:严国平
  编制日期:202010
  功能:信息比对（出口已使用旧设备退税）
...
BEGIN
  ...
  BEGIN
    PROC_XXBD_JSB_TSSB(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='51';
      V_OUT_MESSAGE:='出口已使用旧设备退税明细自检出错：'||SQLCODE||' - '||SQLERRM;
      RETURN;
  END;

  BEGIN
    PROC_XXBD_JSB_TSSB_BGD(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='52';
  ...
  BEGIN
    PROC_XXBD_JSB_TSSB_DLZM(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='53';
  ...
  BEGIN
    PROC_XXBD_JSB_TSSB_ZZSFP(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='54';
  ...
  BEGIN
    PROC_XXBD_JSB_TSSB_JKZZS(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='55';
  ...
  BEGIN
    PROC_XXBD_JSB_CKSH(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='62';
  ...
  BEGIN
    PROC_XXBD_JSB_HGSPTZ(V_IN_NSRDZDAH,V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,V_OUT_STATUS,V_OUT_MESSAGE);
  EXCEPTION
    WHEN OTHERS THEN
      V_OUT_STATUS :='63';
