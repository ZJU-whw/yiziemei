CREATE OR REPLACE PROCEDURE PROC_XXBD_MDT_YFSJ
/*
  编制人:严国平
  编制日期:202009
  功能:信息比对（生产企业免抵退税）
...
BEGIN
  ...
  IF LC_MSG<>' ' OR TRIM(LC_MSG) IS NOT NULL THEN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
            'CKTS_SB_MDT_YFSJ_LSB',NULL,NULL,NULL,NULL,'MDT_BJGX_YSFW_SPDM','E','不允许申报未备案的应税服务[' || LC_MSG || ']。','N',SYSDATE
       FROM DUAL;
    COMMIT;
  END IF;
  ...
  BEGIN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
                'CKTS_SB_MDT_YFSJ_LSB','CKTS_SB_MDT_SYYK_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_YSFW_FWSQ_HTH','E','此合同号[' || T.HTH || ']在零税率应税服务收讫明细中不存在！','N',SYSDATE
           FROM CKTS_SB_MDT_YFSJ_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
                'CKTS_SB_MDT_YFSJ_LSB',NULL,NULL,T.SBXH,NULL,'MDT_YSFW_CKRQ_NSRZG','E','出口日期[' || TO_CHAR(T.KPRQ,'YYYY-MM-DD') || ']企业非增值税一般纳税人！','N',SYSDATE
           FROM CKTS_SB_MDT_YFSJ_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
                'CKTS_SB_MDT_YFSJ_LSB',NULL,NULL,T.SBXH,NULL,'MDT_YSFW_CKRQ_TQQY','E','出口日期[' || TO_CHAR(T.KPRQ,'YYYY-MM-DD') || ']企业处于出口退税停权期间！','N',SYSDATE
           FROM CKTS_SB_MDT_YFSJ_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
                'CKTS_SB_MDT_YFSJ_LSB',NULL,NULL,T.SBXH,NULL,'MDT_YSFW_CKRQ_MSQY','E','出口日期[' || TO_CHAR(T.KPRQ,'YYYY-MM-DD') || ']企业处于免税期间！','N',SYSDATE
           FROM CKTS_SB_MDT_YFSJ_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_XXBD_SHQ_YDID.NEXTVAL,LC_YDOBJECT,
                'CKTS_SB_MDT_YFSJ_LSB',NULL,NULL,T.SBXH,NULL,'MDT_YSFW_CKRQ_FQTS','E','出口日期[' || TO_CHAR(T.KPRQ,'YYYY-MM-DD') || ']放弃零税率应税服务退税期间！','N',SYSDATE
           FROM CKTS_SB_MDT_YFSJ_LSB T
