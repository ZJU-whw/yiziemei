  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_BGD_WDZXX','I','出口货物报关单号[' || T.CKBGDH || ']无电子信息！','Y',CURRENT_TIMESTAMP
    ...
    FOR LSF_XX IN (SELECT A.SBXH,
      ...
      BEGIN
        IF (TIMESTAMPDIFF(MONTH, LSF_XX.CKRQ_SH, LDT_TODAY)>12) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_CKRQ_CQSB','I','出口货物报关单号[' || LSF_XX.CKBGDH || ']退运日期离出口日期[' || DATE_FORMAT(LSF_XX.CKRQ_SH, '%Y-%m-%d') || ']超过12个月！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.TMSZTBZ='已办理退（免）税' AND LSF_XX.TSSBSL=0) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_TMSZT_YSB','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']未退税，但退运证明选择“已办理退（免）税”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        ELSEIF (LSF_XX.TMSZTBZ='尚未申报退（免）税' AND LSF_XX.TSSBSL>0) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_TMSZT_WSB','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']已退税，但退运证明选择“尚未申报退（免）税”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.TYSL>LSF_XX.KTYSL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_TYSL_OVER','I','出口货物报关单号[' || LSF_XX.CKBGDH || ']申报退运数量[' || LSF_XX.TYSL || ']大于可办理退运数量[' || LSF_XX.KTYSL || ']！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.DLSBSL>0 AND LSF_XX.CKHWTYYBSWTSZMBH IS NULL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_DLCK','I','出口货物报关单号[' || LSF_XX.CKBGDH || ']为代理出口业务，没有委托方开具的出口货物已补税（未退税）证明！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.QYGBZ='Y' AND LSF_XX.QYGWDDBZ='Y' AND LSF_XX.QYGCXCKBZ='Y') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_QYG','I','出口货物报关单号[' || LSF_XX.CKBGDH || ']为启运港业务，出口货物未运抵离境港不再实际出口且海关撤销出口货物报关单！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LSF_XX.TYYBSWTSTYLXDM_C IN ('1','2','3') OR LSF_XX.UUID IS NOT NULL THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_TYZM_DUP','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']存在未处理完毕的退运、改单或撤单标识！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LC_TSJSFSDM='1' AND LSF_XX.TYYBSWTSTYLX_DM IN ('2','3') AND LSF_XX.TSSBSL>0 THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_BGD_TMSZT_TYLX','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']已退税，请先红字冲减申报以后办理改单或撤单证明！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_DLZM_WDZXX','I','代理出口货物证明号[' || T.CKBGDH || ']无电子信息！','Y',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    FOR LSF_XX IN (SELECT A.SBXH,
      ...
      BEGIN
        IF (TIMESTAMPDIFF(MONTH, LSF_XX.CKRQ_SH, LDT_TODAY)>12) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_CKRQ_CQSB','I','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']退运日期离出口日期[' || DATE_FORMAT(LSF_XX.CKRQ_SH, '%Y-%m-%d') || ']超过12个月！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.TMSZTBZ='已办理退（免）税' AND LSF_XX.TSSBSL=0) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_TMSZT_YSB','E','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']未退税，但退运证明选择“已办理退（免）税”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        ELSEIF (LSF_XX.TMSZTBZ='尚未申报退（免）税' AND LSF_XX.TSSBSL>0) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_TMSZT_WSB','E','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']已退税，但退运证明选择“尚未申报退（免）税”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.TYSL>LSF_XX.KTYSL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_TYSL_OVER','I','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']申报退运数量[' || LSF_XX.TYSL || ']大于可办理退运数量[' || LSF_XX.KTYSL || ']！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LSF_XX.UUID IS NOT NULL THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_TYZM_DUP','E','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']存在未处理完毕的退运、改单或撤单标识！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LC_TSJSFSDM='1' AND LSF_XX.TYYBSWTSTYLX_DM IN ('2','3') AND LSF_XX.TSSBSL>0 THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_TYBS_DLZM_TMSZT_TYLX','E','代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']已退税，请先红字冲减申报以后办理改单或撤单证明！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_JHPZH_WDZXX','E','进货凭证号码[' || T.JHPZH || ']无电子信息！','N',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_SBTMSE_OVER','E','申报的原退（免）税额[' || T.YSBMDTSE || ']大于进货凭证的税额[' || S.SE || ']！','N',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_SBTMSE_OVER','E','申报的原退（免）税额[' || T.YSBMDTSE || ']大于进货凭证的税额[' || S.SKJE || ']！','N',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_JKSHM_WDZXX','E','该缴款书号码[' || T.JKSHM || ']不存在！','N',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_TYYBSWTS_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_TYBS_JKSE_BYZ','I','补缴税额[' || T.YBJTMSK || ']与实际缴纳税款[' || S.SJJE || ']不符！','Y',CURRENT_TIMESTAMP
           FROM CKTS_ZM_TYYBSWTS_LSB T
