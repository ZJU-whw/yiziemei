  ...
  BEGIN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_ZM_DLCK_LSB',NULL,NULL,T.SBXH,NULL,'TSZM_DLCK_BGD_WDZXX','E','出口货物报关单号[' || T.CKBGDH || ']无电子信息！','N',CURRENT_TIMESTAMP
    ...
    FOR LSF_XX IN (SELECT A.SBXH,
      ...
      BEGIN
        IF (LSF_XX.CKSP_DM_SB<>LSF_XX.CKSP_DM_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_SPDM_BYZ','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']商品代码[' || LSF_XX.CKSP_DM_SB || ']与电子信息中[' || LSF_XX.CKSP_DM_SH || ']不一致！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.CKRQ_SB<>LSF_XX.CKRQ_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_CKRQ_BYZ','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']出口日期[' || DATE_FORMAT(LSF_XX.CKRQ_SB, '%Y-%m-%d') || ']与电子信息中[' || DATE_FORMAT(LSF_XX.CKRQ_SH, '%Y-%m-%d') || ']不一致！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.CKSL_SB>LSF_XX.SYSL_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.CKSL || ']退税申报[' || LSF_XX.TSSBSL || ']退运[' || LSF_XX.TYSL || ']代理申报[' || LSF_XX.DLSBSL || ']）！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.MYLAJ_SB >= LSF_XX.MYLAJ_SH + 1) AND (LSF_XX.MYLAJ_SB >= LSF_XX.MYLAJ_SH * 1.05) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_USDJE_OVER','W','出口货物报关单号[' || LSF_XX.CKBGDH || ']申报美元离岸价[' || LSF_XX.MYLAJ_SB || ']大于电子信息中剩余数[' || LSF_XX.MYLAJ_SH || ']！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.MYLAJ_SB <= LSF_XX.MYLAJ_SH - 1) AND (LSF_XX.MYLAJ_SB <= LSF_XX.MYLAJ_SH * 0.95) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_USDJE_LOW','W','出口货物报关单号[' || LSF_XX.CKBGDH || ']申报美元离岸价[' || LSF_XX.MYLAJ_SB || ']小于电子信息中剩余数[' || LSF_XX.MYLAJ_SH || ']！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;

        SET LN_DJ1 = FUNC_XXBD_COMPUTE_CHUFA(LSF_XX.MYLAJ_SB, LSF_XX.CKSL_SB);
        SET LN_DJ2 = FUNC_XXBD_COMPUTE_CHUFA(LSF_XX.MYLAJ_SH, LSF_XX.SYSL_SH);
        IF (LN_DJ1 > LN_DJ2 * 1.05) OR (LN_DJ1 < LN_DJ2 * 0.95) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_CKDJ_BYZ','W','出口货物报关单号[' || LSF_XX.CKBGDH || ']申报单价与海关信息不匹配！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF INSTR('.'||LSF_XX.HGJLDWMC_WK||'.', '.'||LSF_XX.HGJLDWMC_SB||'.')=0 THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_JLDW_BYZ','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']申报计量单位[' || LSF_XX.HGJLDWMC_SB || ']与报关单第一计量单位不一致！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.CKSP_DM_QXTS IS NOT NULL) THEN
          IF (LSF_XX.WTCKHWZMBH IS NULL) THEN
            ...
            IF LN_ROWNUM_TSSB=0 THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_BTSSP_WTZM','W','出口货物报关单号[' || LSF_XX.CKBGDH || ']商品代码[' || LSF_XX.CKSP_DM_SB || ']为取消退税商品，未找到对应的委托证明信息！','Y',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
          ELSE
            SET LN_ROWNUM_TSSB = LEAST(LENGTH(LSF_XX.CKSP_DM_SB),LENGTH(LSF_XX.CKSP_DM_WT));
            IF (SUBSTR(LSF_XX.CKSP_DM_SB,1,LN_ROWNUM_TSSB)<>SUBSTR(LSF_XX.CKSP_DM_WT,1,LN_ROWNUM_TSSB)) THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_BTSSP_SPDM','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']商品代码[' || LSF_XX.CKSP_DM_SB || ']与委托出口货物证明的同一报关单的商品代码[' || LSF_XX.CKSP_DM_WT || ']不一致！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
          END IF;
        ...
        IF (LSF_XX.TQQY IS NOT NULL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_CKRQ_TQQY','E','出口货物报关单号[' || LSF_XX.CKBGDH || ']对应出口日期为被停止出口退税权期间，不得办理《代理出口证明》！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.WTQY IS NULL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_DLCK_WTFNSR_NULL','W','未查询到委托企业信息，请核实委托企业纳税社会信用码（识别号）是否准确！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LC_WMZHFWQYBZ='Y' AND INSTR(LSF_XX.BZ, 'WMZHFW')=0 THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_ZM_DLCK_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'TSZM_BJGX_DLCK_WZFZG','W','外综服企业申请开具代理出口货物证明，备注栏未录入“WMZHFW”标识”，请确认！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
