  ...
  FOR LSF_XX IN (SELECT * FROM CKTS_DM_GJYSFW A WHERE A.YXBZ='Y') LOOP
    BEGIN
      ...
      IF LN_MXROW>0 AND INSTR(V_IN_GJYSFW,LSF_XX.GJYSFWDM)=0 THEN
        SET LC_MSG =LC_MSG||LSF_XX.GJYSFWMC||',';
      END IF;
    END;
  END LOOP;
  IF LC_MSG<>' ' OR TRIM(LC_MSG) IS NOT NULL THEN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
            'CKTS_SB_MDT_GJYS_LSB',NULL,NULL,NULL,NULL,'MDT_BJGX_GJYS_SPDM','E','不允许申报未备案的国际运输服务[' || LC_MSG || ']。','N',CURRENT_TIMESTAMP
;
    COMMIT;
  END IF;
  ...
  BEGIN
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_GJYS_LSB',NULL,NULL,T.SBXH,NULL,'MDT_GJYS_CKRQ_NSRZG','E','出口日期[' || DATE_FORMAT(T.KPRQ, '%Y-%m-%d') || ']企业非增值税一般纳税人！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_GJYS_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_GJYS_LSB',NULL,NULL,T.SBXH,NULL,'MDT_GJYS_CKRQ_TQQY','E','出口日期[' || DATE_FORMAT(T.KPRQ, '%Y-%m-%d') || ']企业处于出口退税停权期间！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_GJYS_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_GJYS_LSB',NULL,NULL,T.SBXH,NULL,'MDT_GJYS_CKRQ_MSQY','E','出口日期[' || DATE_FORMAT(T.KPRQ, '%Y-%m-%d') || ']企业处于免税期间！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_GJYS_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_GJYS_LSB',NULL,NULL,T.SBXH,NULL,'MDT_GJYS_CKRQ_FQTS','E','出口日期[' || DATE_FORMAT(T.KPRQ, '%Y-%m-%d') || ']放弃零税率应税服务退税期间！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_GJYS_LSB T
