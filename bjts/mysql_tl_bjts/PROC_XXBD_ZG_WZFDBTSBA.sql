        ...
        IF (LSF_XX.DBTSBALCZT_DM='1' AND LSF_XX.WMZHFWHTXYHM_OLD IS NOT NULL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_BAXX_DUP','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']代办退税的备案信息已存在，请选择变更流程！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        ELSEIF(LSF_XX.DBTSBALCZT_DM='2' AND LSF_XX.WMZHFWHTXYHM_OLD IS NULL) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_BAXX_NULL','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']代办退税的备案信息不存在，请选择备案流程！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.NSRSBH IS NOT NULL) THEN
          IF TRIM(LSF_XX.WTDBTSSCQYNSRMC) <> TRIM(LSF_XX.NSRMC) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_BAXX_BYZ','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']对应的名称与该企业委托代办备案信息不一致！','N',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
          ...
          IF (LSF_XX.WTDBTSSCQYDBTSKHYHZH<>LSF_XX.TSKHYHZH) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_YHXX_BYZ','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']对应的退税银行账户与该企业委托代办备案信息不一致！','N',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
          ...
          IF (LSF_XX.WTDBTSSCQYDBTSKHYHMC <> LSF_XX.TSKHYHMC) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_YHXX_BYZ','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']对应的退税银行名称与该企业委托代办备案信息不一致！','Y',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
          ...
          IF (LSF_XX.WMZHFWHTXYHM_NEW <> LSF_XX.WMZHFWHTXYHM_SC) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_HTXX_BYZ','E','生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']对应的代办退税协议与该企业委托代办备案信息不一致！','N',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
        ELSE
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      'CKTS_BA_WMZHFWDBTS_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'BA_DBTS_WZF_SCQYWBA','E','缺少生产企业[' || LSF_XX.WTDBTSSCQYNSRSBH || ']的委托代办备案信息！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
