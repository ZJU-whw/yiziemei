  ...
  BEGIN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_HGSPTZ_LSB','CKTS_SB_MDT_TSSB_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_DMTZ_CKHW_CKPZ','E','出口货物报关单号/代理出口货物证明号[' || IFNULL(T.DLCKHWZMHM, T.CKBGDH) || ']未申报免退税出口明细！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_HGSPTZ_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_HGSPTZ_LSB','CKTS_SB_MDT_TSSB_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_DMTZ_CKHW_CKRQ','E','出口货物报关单号/代理出口货物证明号[' || IFNULL(T.DLCKHWZMHM, T.CKBGDH) || ']的出口日期与免退税出口明细表中不一致！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_HGSPTZ_LSB T
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_HGSPTZ_LSB','CKTS_SB_MDT_TSSB_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_DMTZ_CKHW_SPDM','E','出口货物报关单号/代理出口货物证明号[' || IFNULL(T.DLCKHWZMHM, T.CKBGDH) || ']调整前商品代码与免退税出口明细表中不一致！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_HGSPTZ_LSB T
          INNER JOIN CKTS_SB_MDT_TSSB_LSB S ON S.SBID=T.SBID AND IFNULL(S.DLCKHWZMHM, S.CKBGDH)=IFNULL(T.DLCKHWZMHM, T.CKBGDH)
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_HGSPTZ_LSB','CKTS_SB_MDT_TSSB_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_DMTZ_CKHW_ZSLV','E','出口货物报关单号/代理出口货物证明号[' || IFNULL(T.DLCKHWZMHM, T.CKBGDH) || ']调整后商品代码在对应出口日期的退税率文库中的征税率与货物出口明细表中不一致！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_HGSPTZ_LSB T
          INNER JOIN CKTS_SB_MDT_TSSB_LSB S ON S.SBID=T.SBID AND IFNULL(S.DLCKHWZMHM, S.CKBGDH)=IFNULL(T.DLCKHWZMHM, T.CKBGDH)
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_HGSPTZ_LSB','CKTS_SB_MDT_TSSB_LSB',NULL,T.SBXH,NULL,'MDT_BJGX_DMTZ_CKHW_TSLV','E','出口货物报关单号/代理出口货物证明号[' || IFNULL(T.DLCKHWZMHM, T.CKBGDH) || ']调整后退税率与免退税进货明细表中不一致！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_HGSPTZ_LSB T
          INNER JOIN CKTS_SB_MDT_TSSB_LSB S ON S.SBID=T.SBID AND IFNULL(S.DLCKHWZMHM, S.CKBGDH)=IFNULL(T.DLCKHWZMHM, T.CKBGDH)
          WHERE T.SBID=V_IN_SBID
            AND T.TZHTSL<>S.TSL;
