              ...
              IF (LSF_XX.CKSL_SB + LSF_XX.TSSBSL <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            ...
                            '出口货物报关单号[' || LSF_XX.CKBGDH || ']业务类型选择红字冲减，出口数量与已申报出口数量[' || LSF_XX.TSSBSL || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
              IF (LSF_XX.MYLAJ_SB + LSF_XX.TSSBMYLAJ <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_CKHW_BGD_HZCJ_BYZ','E',
                            '出口货物报关单号[' || LSF_XX.CKBGDH || ']业务类型选择红字冲减，美元离岸价与已申报美元离岸价[' || LSF_XX.TSSBMYLAJ || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
              IF (LSF_XX.RMBLAJ_SB + LSF_XX.TSSBRMBLAJ <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_CKHW_BGD_HZCJ_BYZ','E',
                            '出口货物报关单号[' || LSF_XX.CKBGDH || ']业务类型选择红字冲减，人民币离岸价与已申报人民币离岸价[' || LSF_XX.TSSBRMBLAJ || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
            END;
          ELSE
            ...
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        ...
                        '出口货物报关单号[' || LSF_XX.CKBGDH || ']业务类型选择红字冲减-退运，请核实退运冲减的人民币离岸价与应冲减的退运证明对应的实际出口销售额是否一致！','Y',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
        ELSE
              ...
              BEGIN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            ...
                            '出口货物报关单号[' || LSF_XX.CKBGDH || ']美元离岸价[' || LSF_XX.MYLAJ_SB || ']超过电子信息中[' || LSF_XX.MYLAJ || ']合理范围，需提供《出口货物离岸价差异原因说明表》！','N',CURRENT_TIMESTAMP
;
                COMMIT;
                ...
                IF (LSF_XX.CKBGDH_GD IS NOT NULL) AND ((ABS(LSF_XX.MYLAJ_SB-LSF_XX.MYLAJ_GD)<=1) OR (ABS(LSF_XX.MYLAJ_SB-LSF_XX.MYLAJ_GD)<=0.05 * LSF_XX.MYLAJ_GD)) THEN
                  INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                       SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                              ...
                              '出口货物报关单号[' || LSF_XX.CKBGDH || ']存在改单后信息，且改单后信息未同步到报关单电子信息中！','Y',CURRENT_TIMESTAMP
;
                  COMMIT;
                END IF;
              END;
            ...
            IF (TRIM(LSF_XX.CYTSSBJL) IS NOT NULL) AND (LSF_XX.TSSBSL>0) THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          '出口货物报关单号[' || LSF_XX.CKBGDH || ']曾经参与历史申报，请确认是否重复！','Y',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
            ...
            IF LSF_XX.QYGBZ<>'Y' THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          'E','出口货物报关单号[' || LSF_XX.CKBGDH || ']非启运港业务，“业务类型”不应包含“QYGTS”！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            ELSEIF (INSTR(LSF_XX.CKTMSYWLXDMJH,'HZCJ')=0) THEN
              BEGIN
        ...
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'XLXP')>0 AND LSF_XX.JGFS_DM<>'1300') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '出口货物报关单号[' || LSF_XX.CKBGDH || ']非修理修配业务，请确认“业务类型”是否选择正确！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'XLXP')=0 AND LSF_XX.JGFS_DM='1300') THEN
        ...
        IF LSF_XX.YSFS_DM='8' AND LSF_XX.ZZMDGDQSZ_DM='142' THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '出口货物报关单号[' || LSF_XX.CKBGDH || ']为保税仓库转内销！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
            ...
            IF LSF_XX.JLJGSZCH IS NULL THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          '出口货物报关单号[' || LSF_XX.CKBGDH || ']在电子信息中监管方式为0615/0715，出口明细未申报进料加工手册号！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            ELSEIF LSF_XX.JLJGSZCH <> LSF_XX.BAH THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_JLJG_JGMYSCH','E',
                          '出口货物报关单号[' || LSF_XX.CKBGDH || ']申报的进料加工手账册号与电子信息中不一致！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
            ...
            IF LSF_XX.TZHJHFPL IS NULL THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          '出口货物报关单号[' || LSF_XX.CKBGDH || ']在电子信息中监管方式为0615/0715，出口明细未申报计划分配率！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            ELSE
              BEGIN
                ...
                IF (LSF_XX.SJFPL IS NULL) AND (LSF_XX.TZHJHFPL<>LN_ZHJHFPL) THEN
                  INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                       SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                              ...
                              '申报的进料加工计划分配率与当前有效的计划分配率[' || LN_ZHJHFPL || ']不一致，请反馈计划分配率后重新申报！','N',CURRENT_TIMESTAMP
;
                  COMMIT;
                END IF;
              END;
          ...
          IF (LSF_XX.JLJGSZCH IS NOT NULL) OR (IFNULL(LSF_XX.TZHJHFPL, 0)<>0) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        ...
                        '出口货物报关单号[' || LSF_XX.CKBGDH || ']申报了手册号（或计划分配率），电子信息中监管方式非0615/0715，请确认！','Y',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
        END IF;
        ...
        IF (LSF_XX.CKSL_SB > 0) AND (LSF_XX.CKSL_SB - LSF_XX.SYSL_SH > 0) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.CKSL || ']退税申报[' || LSF_XX.TSSBSL || ']退运[' || LSF_XX.TYSL || ']代理出口[' || LSF_XX.DLSBSL || ']）！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.MYLAJ_SB>0) AND (LSF_XX.MYLAJ_SB - LSF_XX.MYLAJ_SH > 1) AND (LSF_XX.MYLAJ > LSF_XX.MYLAJ_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.MYLAJ || ']退税申报[' || LSF_XX.TSSBMYLAJ || ']退运[' || LSF_XX.TYMYLAJ || ']代理出口[' || LSF_XX.DLSBMYLAJ || ']）！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.RMBLAJ_SB>0) AND (LSF_XX.RMBLAJ_SB - LSF_XX.RMBLAJ_SH > 1) AND (LSF_XX.RMBLAJ > LSF_XX.RMBLAJ_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.RMBLAJ || ']退税申报[' || LSF_XX.TSSBRMBLAJ || ']退运[' || LSF_XX.TYRMBLAJ || ']代理出口[' || LSF_XX.DLSBRMBLAJ || ']）！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
