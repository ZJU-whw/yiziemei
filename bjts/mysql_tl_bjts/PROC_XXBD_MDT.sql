...
routine_body: BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='62';
      SET V_OUT_MESSAGE ='出口收汇申报资料自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='64';
      SET V_OUT_MESSAGE ='离岸价差异说明表自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='65';
      SET V_OUT_MESSAGE ='先退后核申报资料自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='66';
      SET V_OUT_MESSAGE ='视同自产清单自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='71';
      SET V_OUT_MESSAGE ='零税率应税服务明细自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='72';
      SET V_OUT_MESSAGE ='零税率应税服务收讫自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='81';
      SET V_OUT_MESSAGE ='国际（港澳台）运输服务明细自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='82';
      SET V_OUT_MESSAGE ='航空运输清算账单自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='83';
      SET V_OUT_MESSAGE ='国际客运清算函件自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
  ...
  EXCEPTION
    WHEN OTHERS THEN
      SET V_OUT_STATUS ='84';
      SET V_OUT_MESSAGE ='中铁国际货运明细自检出错：'||SQLCODE||' - '||SQLERRM;
      LEAVE routine_body;
  END;
