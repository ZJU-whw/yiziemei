  ...
  BEGIN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MTS_TSJH_LSB','CKTS_SB_MTS_TSSB_LSB',NULL,T.SBXH,T.GLH,'MTS_BJGX_JHMX_CKMX_GLH','E','进货明细中的关联号[' || T.GLH || ']在出口明细中不存在！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MTS_TSJH_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MTS_TSJH_LSB','CKTS_SB_MTS_TSSB_LSB',NULL,T.SBXH,T.GLH,'MTS_BJGX_JHMX_CKMX_SPDM','E','进货明细中的关联号[' || T.GLH || ']商品代码[' || T.CKSP_DM || ']在出口明细中不存在！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MTS_TSJH_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MTS_TSJH_LSB','CKTS_SB_MTS_TSSB_LSB',NULL,T.SBXH,T.GLH,'MTS_BJGX_JHMX_CKMX_JLDW','E','进货明细中的关联号[' || T.GLH || ']计量单位[' || T.HGJLDWMC || ']在出口明细中不存在！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MTS_TSJH_LSB T
          WHERE T.SBID=V_IN_SBID
    ...
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         ...
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MTS_TSJH_LSB','CKTS_SB_MTS_TSSB_LSB',NULL,NULL,JH.GLH,'MTS_BJGX_JHMX_CKMX_CKSL','E','进货明细中的关联号[' || JH.GLH || ']商品代码[' || JH.CKSP_DM || ']进货数量[' || JH.JHSL || ']大于出口数量[' || IFNULL(CK.CKSL, 0.00) || ']！','N',CURRENT_TIMESTAMP
           FROM JH
