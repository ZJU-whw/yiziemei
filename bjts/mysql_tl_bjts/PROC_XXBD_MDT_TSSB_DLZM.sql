  ...
  BEGIN
    INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
         SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,T.SBXH,NULL,'MDT_CKHW_DLZM_WDZXX','E','代理出口货物证明号[' || T.DLCKHWZMHM || ']无电子信息！','N',CURRENT_TIMESTAMP
           FROM CKTS_SB_MDT_TSSB_LSB T
          WHERE T.SBID=V_IN_SBID
            AND T.DLCKHWZMHM IS NOT NULL
              ...
              IF (LSF_XX.CKSL_SB + LSF_XX.TSSBSL <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            ...
                            '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']业务类型选择红字冲减，出口数量与已申报出口数量[' || LSF_XX.TSSBSL || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
              IF (LSF_XX.MYLAJ_SB + LSF_XX.TSSBMYLAJ <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_CKHW_DLZM_HZCJ_BYZ','E',
                            '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']业务类型选择红字冲减，美元离岸价与已申报美元离岸价[' || LSF_XX.TSSBMYLAJ || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
              IF (LSF_XX.RMBLAJ_SB + LSF_XX.TSSBRMBLAJ <>0) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_CKHW_DLZM_HZCJ_BYZ','E',
                            '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']业务类型选择红字冲减，人民币离岸价与已申报人民币离岸价[' || LSF_XX.TSSBRMBLAJ || ']不一致！','N',CURRENT_TIMESTAMP
;
                COMMIT;
              END IF;
            END;
          ELSE
            ...
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        ...
                        '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']业务类型选择红字冲减-退运，请核实退运冲减的人民币离岸价与应冲减的退运证明对应的实际出口销售额是否一致！','Y',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
        ELSE
            ...
            IF (ABS(LSF_XX.MYLAJ_SB-LSF_XX.MYLAJ)>1) AND (ABS(LSF_XX.MYLAJ_SB-LSF_XX.MYLAJ)>0.05 * LSF_XX.MYLAJ) AND (LSF_XX.CKFPMYLAJ IS NULL) THEN
                INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                     SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                            ...
                            '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']美元离岸价[' || LSF_XX.MYLAJ_SB || ']超过电子信息中[' || LSF_XX.MYLAJ || ']合理范围，需提供《出口货物离岸价差异原因说明表》！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
        ...
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'DWCB')>0 AND LSF_XX.JGFS_DM<>'3422' AND LSF_XX.JGFS_DM<>'22') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']非对外承包业务，“业务类型”不应包含“DWCB”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'DWCB')=0 AND (LSF_XX.JGFS_DM='3422' OR LSF_XX.JGFS_DM='22')) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']为对外承包业务，“业务类型”应包含“DWCB”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'JWTZ')>0 AND LSF_XX.JGFS_DM<>'2210') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']非境外投资业务，“业务类型”不应包含“JWTZ”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'JWTZ')=0 AND LSF_XX.JGFS_DM='2210') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']为境外投资业务，“业务类型”应包含“JWTZ”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'DWYZ')>0 AND LSF_XX.JGFS_DM<>'3511') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']非对外援助业务，“业务类型”不应包含“DWYZ”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'DWYZ')=0 AND LSF_XX.JGFS_DM='3511') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']为对外援助业务，“业务类型”应包含“DWYZ”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'XLXP')>0 AND LSF_XX.JGFS_DM<>'1300') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']非修理修配业务，“业务类型”不应包含“XLXP”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        IF (INSTR(LSF_XX.CKTMSYWLXDMJH,'XLXP')=0 AND LSF_XX.JGFS_DM='1300') THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']为修理修配业务，“业务类型”应包含“XLXP”！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF LSF_XX.YSFS_DM='8' AND LSF_XX.ZZMDGDQSZ_DM='142' THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']为保税仓库转内销！','N',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
            ...
            IF LSF_XX.JLJGSZCH IS NULL THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']在电子信息中监管方式为0615/0715，出口明细未申报进料加工手册号！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            END IF;
            ...
            IF LSF_XX.TZHJHFPL IS NULL THEN
              INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                   SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                          ...
                          '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']在电子信息中监管方式为0615/0715，出口明细未申报计划分配率！','N',CURRENT_TIMESTAMP
;
              COMMIT;
            ELSE
              BEGIN
...
;
        ...
        ELSE
          ...
          IF (LSF_XX.JLJGSZCH IS NOT NULL) OR (IFNULL(LSF_XX.TZHJHFPL, 0)<>0) THEN
            INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
                 SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                        'CKTS_SB_MDT_TSSB_LSB',NULL,NULL,LSF_XX.SBXH,NULL,'MDT_JLJG_SCH_NOJLJG','I',
                        '代理出口货物证明号[' || LSF_XX.DLCKHWZMHM || ']申报了手册号（或计划分配率），电子信息中监管方式非0615/0715，请确认！','Y',CURRENT_TIMESTAMP
;
            COMMIT;
          END IF;
        END IF;
        ...
        IF (LSF_XX.MYLAJ_SB>0) AND (LSF_XX.MYLAJ_SB - LSF_XX.MYLAJ_SH > 1) AND (LSF_XX.MYLAJ > LSF_XX.MYLAJ_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.MYLAJ || ']退税申报[' || LSF_XX.TSSBMYLAJ || ']退运[' || LSF_XX.TYMYLAJ || ']）！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
        ...
        IF (LSF_XX.RMBLAJ_SB>0) AND (LSF_XX.RMBLAJ_SB - LSF_XX.RMBLAJ_SH > 1) AND (LSF_XX.RMBLAJ > LSF_XX.RMBLAJ_SH) THEN
          INSERT INTO CKTS_XXBD_SHQ_YDXX(DJXH,SBYWB_DM,SSSQ,SBPC,SBID,ERR_LY,XH,ERR_OBJ,GLYWB1,GLYWB2,GLYWB3,GLYWZ1,GLYWZ2,YDCODE,ERR_LEV,ERR_MSG,PASS_FLAG,CRTIME)
               SELECT V_IN_DJXH,V_IN_SBYWBDM,V_IN_SSSQ,V_IN_SBPC,V_IN_SBID,'1',SEQ_NEXTVAL('SEQ_XXBD_SHQ_YDID'),LC_YDOBJECT,
                      ...
                      ']（其中出口[' || LSF_XX.RMBLAJ || ']退税申报[' || LSF_XX.TSSBRMBLAJ || ']退运[' || LSF_XX.TYRMBLAJ || ']）！','Y',CURRENT_TIMESTAMP
;
          COMMIT;
        END IF;
      END;
