...
public class BgdMainVO {
    ...
    @ConvertCode(dtype = TlConst.DICT_HGCODE)
    ...
    @ConvertCode(dtype = TlConst.DICT_TRANSTYPE)
    ...
    @ConvertCode(dtype = TlConst.DICT_TDCODE)
    ...
    @ConvertCode(dtype = TlConst.DICT_ZYGCODE)
    ...
    @ConvertCode(dtype = TlConst.DICT_BZZLCODE)
    ...
    @ConvertCode(dtype = TlConst.DICT_CJFSCODE)
