...
/**
 * 免抵退报关单信息VO - 用于121指标
 * 接收selectMdtBgxx121 SQL查询结果
 */
public class MdtBgxx121Vo {
    ...
    public String getDlckhwzmhm() {
        return dlckhwzmhm;
    }

    public void setDlckhwzmhm(String dlckhwzmhm) {
        this.dlckhwzmhm = dlckhwzmhm;
    }
