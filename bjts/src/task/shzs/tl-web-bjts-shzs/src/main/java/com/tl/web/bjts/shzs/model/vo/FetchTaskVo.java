...
public class FetchTaskVo {
    ...
    public String getCkqygllbDm() {
        return this.ckqygllbDm;

    }

    public void setCkqygllbDm(String ckqygllbDm) {
        this.ckqygllbDm = ckqygllbDm;
    }
