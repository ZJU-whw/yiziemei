    ...
    defaults: {
      ...
      createTable:function(){
        ...
        var columns = [
          ...
          { name: "blzt", label: "办理状态", index: "blzt",width: 70, align:"center",sortable: true },
      ...
      search:function(pageNo){
        ...
        if (this.searchData.exceedType == '1') {
          if(this.searchData.exceedDays == '') {
            ...
            return;
          } else if (this.searchData.exceedDays<=0 || this.searchData.exceedDays>=15) {
            tools.info('即将超期天数必须大于0且小于15');
            return;
          }
        } else if (this.searchData.exceedType == '2') {
          if(this.searchData.exceedDays == '') {
      ...
      exceedTypeChange: function(){
        if (this.searchData.exceedType == '') {
          this.searchData.exceedDays = ''
          this.exceedText = '超期天数'
        } else if (this.searchData.exceedType == '1') {
          this.searchData.exceedDays = '3'
          this.exceedText = '即将超期天数'
        } else if (this.searchData.exceedType == '2') {
          this.searchData.exceedDays = '3'
          this.exceedText = '已经超期天数'
        }
      }
    }
});