var zxjdzbpzmx = require("./zxjdzbpzmx.html");
avalon.component("zxjdzbpzmx", {
  template: zxjdzbpzmx,
  defaults: {
    params: {
      zbId: "",
    ...
    onReady: function () {
      ...
      this.createTableCs();
      var el1 = $(".zxjdzbpzmx .more1")[0];
      var el2 = $(".zxjdzbpzmx .more2")[0];
    ...
    createTableYcff: function () {
      ...
      var columns = [
        ...
        },
        {
          ...
          formatter: function (cellvalue, options, rowObject) {
            ...
            op +=
              "<div class='btn del' style='float: none;display: inline-block;' title='删除'>删除</div>";
            op += "</div>";
            return op;
          },
        },
      ...
      $("#zxjdzbpzmx-ycff-table").jqGrid({
        datatype: "local",
        gridview: true,
        colModel: columns,
        viewrecords: true,
        rownumbers: true,
        pager: "#zxjdzbpzmx-ycff-tablePager",
        shrinkToFit: false,
        autowidth: true,
        altRows: true,
        // multiselect: true,
        ...
        height: (function () {
          return (
            ($(".zxjdzbpzmx .form").height() -
              $(".zxjdzbpzmx .msg").height() -
              189) /
            2
          );
        })(),
        beforeSelectRow: function (rowid, e) {
          var row = $("#zxjdzbpzmx-ycff-table").jqGrid("getRowData", rowid);
        ...
        onPaging: function (pgButton) {
          var pageNo = tools.getPageNo(pgButton, "zxjdzbpzmx-ycff-table");
          self.searchYcff(pageNo);
        },
      });
      this.searchYcffData.pageSize = $(".ui-pg-selbox", $(".zxjdzbpzmx")).val();
      self.searchYcff(1);
    },
    createTableCs: function () {
      ...
      $("#zxjdzbpzmx-cs-table").jqGrid({
        datatype: "local",
        gridview: true,
        colModel: columns,
        viewrecords: true,
        rownumbers: true,
        pager: "#zxjdzbpzmx-cs-tablePager",
        shrinkToFit: false,
        autowidth: true,
        altRows: true,
        // multiselect: true,
        ...
        beforeSelectRow: function (rowid, e) {
          var row = $("#zxjdzbpzmx-cs-table").jqGrid("getRowData", rowid);
          if ($(e.target).hasClass("edit")) {
        ...
        onPaging: function (pgButton) {
          var pageNo = tools.getPageNo(pgButton, "zxjdzbpzmx-cs-table");
          self.searchCs(pageNo);
        },
      });
      this.searchCsData.pageSize = $(".ui-pg-selbox", $(".zxjdzbpzmx")).val();
      self.searchCs(1);
    },
    showModelYcff: function (operation) {
      ...
      $(".model").show();
      $(".zxjdzbpzmx .ycff-page-model").show();
    },
    hideModelYcff: function () {
      $(".model").hide();
      $(".zxjdzbpzmx .ycff-page-model").hide();
      this.modelYcffData = {
        xh: "",
        ycpdtj: "",
        lwgz: "",
    ...
    showModelCs: function (operation) {
      ...
      $(".model").show();
      $(".zxjdzbpzmx .cs-page-model").show();
    },
    hideModelCs: function () {
      $(".model").hide();
      $(".zxjdzbpzmx .cs-page-model").hide();
      this.modelCsData = {
        csbm: "",
        csmc: "",
        datatype: "",
    ...
    searchYcff: function (pageNo) {
      var self = this;
      // this.searchYcffData.pageSize = $(".ui-pg-selbox", $('.zxjdzbpzmx .ycff')).val() || 20;
      // var params=tools.clone(self.searchYcffData);
      // params.pageNo=pageNo;
      // $("#zxjdzbpzmx-ycff-table").jqGrid('clearGridData')
      // ajax("POST","/sszj/zbgl/zb/ycff/swjg/list",params).done(function(res){
      // 	if(res.code=='0'){
      // 		$("#zxjdzbpzmx-ycff-table").resetSelection();
      // 		$("#zxjdzbpzmx-ycff-table")[0].addJSONData(res.data);
      // 	}else{
      // 		tools.info(res.msg);
      // 	}
      // }).fail(function(err){
    ...
    searchCs: function (pageNo) {
      ...
      this.searchCsData.pageSize =
        $(".ui-pg-selbox", $(".zxjdzbpzmx .cs")).val() || 20;
      var params = tools.clone(self.searchCsData);
      params.pageNo = pageNo;
      $("#zxjdzbpzmx-cs-table").jqGrid("clearGridData");
      ajax("POST", "/sszj/zxjg/zbgl/zb/cs/swjg/list", params)
        .done(function (res) {
          if (res.code == "0") {
            $("#zxjdzbpzmx-cs-table").resetSelection();
            $("#zxjdzbpzmx-cs-table")[0].addJSONData(res.data);
          } else {
            tools.info(res.msg);
          }
        })
    ...
    saveModelYcff: function () {
      ...
      url = "/sszj/zxjg/zbgl/zb/ycff/update";
      ...
      ajax("POST", url, this.modelYcffData)
        .done(function (res) {
          if (res.code == "0") {
            tools.info("保存成功！");
            self.hideModelYcff();
    ...
    saveModelCs: function () {
      ...
      url = "/sszj/zxjg/zbgl/zb/cs/update";
      for (var i = 0; i < rules.length; i++) {
      ...
      ajax("POST", url, this.modelCsData)
        .done(function (res) {
          if (res.code == "0") {
            tools.info("保存成功！");
            self.hideModelCs();
