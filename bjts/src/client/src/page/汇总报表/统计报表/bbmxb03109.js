var bbmxb03109=require("./bbmxb03109.html");
var chart;
avalon.component('bbmxb03109', {
    template:bbmxb03109,
    defaults: {
        params:{
            bbdm:"",
        ...
        onReady:function(){
            ...
            self.isIE();
            //统计表初始化
            $('#bbmxb03109-chart').width($('.bbmxb03109').width());
            self.chartOption.title.subtext="申报年月:"+self.searchData.ssny;
            chart = echarts.init(document.getElementById('bbmxb03109-chart'));
        ...
        search:function(page){
            ...
            ajax("POST","/bjtssw/tjbb/loaddata",params).done(function(res){
                if(res.code=='0'){
                    ...
                    if(!self.scFlag){
                        $(".bbmxb03109 .table-body-wrapper").scroll(function () {
                            $(".bbmxb03109 .table-head-wrapper").scrollLeft($(".table-body-wrapper").scrollLeft())
                        })
                        self.scFlag=true;
                    }
                    // self.calTable();
        ...
        fleshChart:function(data){
            ...
            for(var rowNum=1;rowNum<data.rows.length;rowNum++){
                ...
                ckbzData.push({value:row['CKE_LJ'],name:row['HGMC']})
            }
        ...
        showHyper:function(){
            $('.bbbbmxb03109 .hyper').toggle();
            $('.bbbbmxb03109 .hyperBtn').toggleClass('active');
        },
        closeHyper:function(){
            $('.bbbbmxb03109 .hyper').hide();
            $('.bbbbmxb03109 .hyperBtn').removeClass('active');
        },
        filDate:function(e){
        ...
        showMenu:function(e){
            ...
            $('.bbmxb03109').on('click',function(e){
        ...
        initTree:function() {
            ...
            ajax("POST","/cxfw/export/readtree", {nodeType:"3"}).done(function(res){
                if(res.code=='0'){
                    $.fn.zTree.init($(".bbbbmxb03109 .treeDiv"), setting, res.data);
                }else{
                    tools.info(res.msg)
                }
            }).fail(function(err){
        ...
        showTree:function(e){
            ...
            $('.bbbbmxb03109').on('click',function(e){
                var e=e||window.event;
