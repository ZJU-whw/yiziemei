var bbmxb03101=require("./bbmxb03101.html");
var chart;
avalon.component('bbmxb03101', {
    template:bbmxb03101,
    defaults: {
        params:{
            bbdm:"",
        ...
        onReady:function(){
            ...
            //统计表初始化
            $('#bbmxb03101-chart').width($('.bbmxb03101').width());
            self.chartOption.title.subtext="申报年月:"+self.searchData.ssny;
            chart = echarts.init(document.getElementById('bbmxb03101-chart'));
        ...
        search:function(page){
            ...
            ajax("POST","/bjtssw/tjbb/loaddata",params).done(function(res){
                if(res.code=='0'){
                    ...
                    if(!self.scFlag){
                        $(".bbmxb03101 .table-body-wrapper").scroll(function () {
                            $(".bbmxb03101 .table-head-wrapper").scrollLeft($(".table-body-wrapper").scrollLeft())
                        })
                        self.scFlag=true;
                    }
                    // self.calTable();
        ...
        fleshChart:function(data){
            ...
            self.chartOption.series[1].data=tools.clone(lineSer[0]);
            chart.setOption(tools.clone(self.chartOption));
        },
        saveBB:function(){
            var self=this;
        ...
        showHyper:function(){
            $('.bbbbmxb03101 .hyper').toggle();
            $('.bbbbmxb03101 .hyperBtn').toggleClass('active');
        },
        closeHyper:function(){
            $('.bbbbmxb03101 .hyper').hide();
            $('.bbbbmxb03101 .hyperBtn').removeClass('active');
        },
        filDate:function(e){
        ...
        showMenu:function(e){
            ...
            $('.bbmxb03101').on('click',function(e){
        ...
        initTree:function() {
            ...
            ajax("POST","/cxfw/export/readtree", {nodeType:"3"}).done(function(res){
                if(res.code=='0'){
                    $.fn.zTree.init($(".bbbbmxb03101 .treeDiv"), setting, res.data);
                }else{
                    tools.info(res.msg)
                }
            }).fail(function(err){
        ...
        showTree:function(e){
            ...
            $('.bbbbmxb03101').on('click',function(e){
                var e=e||window.event;
