				...
				if (iCol >= 0) {
					...
					if (skip === 0) {
						if (o.useColSpanStyle) {
							...
							// expand the header height to many rows 多级表头支持
...
function getCellData(tableName,rowId,iCol){
    return $("#"+tableName+" tr[id='"+rowId+"'] td[aria-describedby='"+tableName+"_"+iCol+"']").text();
