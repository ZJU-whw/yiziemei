CREATE OR REPLACE PROCEDURE PRO_FXGL_COMPUTE_C03001
/*
 * 农产品出口异常模型
  ...
  LOOP
    ...
    IF V_MYLAJ>=V_MYLAJ_LX3M THEN
      INSERT INTO FXGL_DATA_ZXZB(ID,TSSWJG_DM,DJXH,NSRSBH,NSRMC,SMLX,SMRQ,ZBID,ZBCS,SMJG)
           SELECT SEQ_FXGL_DATA_ZXZB.NEXTVAL,TT.SWJGDM,TT.DJXH_JS,NVL(TT.SHXYNO,TT.NSRDJNO),TT.NSRMC,NVL(P_SMLX,'0'),SYSDATE,'C03001',
