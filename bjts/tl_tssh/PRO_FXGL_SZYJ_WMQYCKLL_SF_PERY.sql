CREATE OR REPLACE PROCEDURE PRO_FXGL_SZYJ_WMQYCKLL_SF_PERY
/*
...
BEGIN
  ...
  select s.djxh,
   ...
   inner join ckts_wbsj_hg_bgd s on s.ckbgdh=t.ckbgdh and s.djxh=t.djxh
    left join tl_admin.dm_xzqh_sf hyd on hyd.dm=zygys.ghdz
    ...
    left join tl_admin.dm_xzqh_sf hg on hg.dm=ka.xzqh_dm
